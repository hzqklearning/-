...
const https = require("https") //客户端与服务器第一次连接协议 获取页面
...
//配置信息
const options = {
    key:fs.readFileSync("/root/https/server/www.hzq2024.fun.key"),
    cert:fs.readFileSync("/root/https/server/www.hzq2024.fun.pem")
}
